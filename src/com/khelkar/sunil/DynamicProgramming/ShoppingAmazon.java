...
public class ShoppingAmazon {
	...
	public static void main(String[] args) {
		...
		int[] jeans= {500,30, 555,150,200, 666,432,234};
		int[] shoes= {100,150,200, 666,432,234};
		int [] skirt= {300, 400, 500,232,212,236,786};
		int[] top = {78,989,234,23,43,12,150,200, 666,432,234};
		...
		System.out.println("Iterations this algo took:  " + iterations);
	}
	...
	public static int shop(int[] jeans, int[] shoes, int [] skirt, int[] top, int budget,int type) {
		...
		for (int i=0; i<items.length; i++) {
			...
			if (temp == 0) {
				...
				return count; // want to see the difference in number of iteration, just comment this line and note the number of iteration number getting increased
			}
